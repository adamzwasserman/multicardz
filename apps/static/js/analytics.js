...
(function(window) {
    ...
    /**
     * Get or create persistent anonymous user ID (cookie-based, 90-day lifespan).
     *
     * This persists across sessions and allows tracking users from
     * first visit → signup → paid conversion.
     *
     * @returns {string} Anonymous user ID (UUID format)
     */
    function getOrCreateAnonymousUserId() {
        ...
        setCookie(cookieName, anonymousUserId, 90);
     ...
     * @param {string} anonymousUserId - Persistent anonymous user ID (cookie)
     * @returns {object} Session data
     */
    function createSessionData(sessionId, anonymousUserId) {
    ...
    function multicardzAnalytics() {
        ...
        const sessionData = createSessionData(sessionId, anonymousUserId);
