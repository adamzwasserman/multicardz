...
#### 3. Project Database Schema (Identical for Turso/SQLite due to compatibility)
```sql
...
- **[NEW]** Will add middleware-based event capture to Kafka
...
- **Fixed Drag-Drop Flow**: Already exists: browser DOM → tagsInPlay → /api/render/cards → HTML response
...
| 9-10 | Hybrid Rendering & Communication | Enhance existing drag-drop flow, content injection | <200ms end-to-end, proper separation |
